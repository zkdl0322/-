...
//  DrawGraphics
//
//  Created by 203a22 on 2022/06/03.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func btnDrawLine(_ sender: UIButton) {
        ...
        context.addLine(to: CGPoint(x: 270, y: 510))
        context.addLine(to: CGPoint(x: 230, y: 700))
        context.addLine(to: CGPoint(x: 110, y: 700))
        context.addLine(to: CGPoint(x: 70, y: 510))
    ...
    @IBAction func btnDrawCircle(_ sender: UIButton) {
        ...
        context.addEllipse(in:CGRect(x: 70, y: 100, width: 200, height: 200))
        context.strokePath()
